                ...
                <div class="flex flex-col items-center gap-3">
                    <div data-count="0" class="flex flex-row justify-center">
                        <div class="flex flex-col items-end gap-3 lg:gap-5 mt-3 md:mt-5 border-b border-gray-300 pb-3">
                            ...
                            <div class="w-full flex flex-col">
                                ...
                                <input type="text"
                                    class="outline-none w-ful lg:w-1/2 pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#efefef]"
                                    ...
                                    <div class="flex flex-col lg:flex-row items-center pr-10 gap-3">
                                        ...
                                        <div class="w-full flex flex-col">
                                            ...
                                            <input type="number"
                                                ...
                                                name="page_data[0][values][0][price]" placeholder="500.000تومان">
                                        </div>
                                        <div class="w-full flex flex-col">
                            ...
                            <button type="button"
                                class="w-full h-10 rounded-[8px] bg-green-500 text-white text-lg text-center inline-block mt-3"
                    ...
                    <div class="w-full flex items-center flex-col">
                        ...
                        <input type="number" placeholder="5"
                            class="outline-none w-60 pr-5 py-3 bg-[#F9F9F9] rounded-[8px] focus:bg-[#f1f1f4]"
                            name="qr_num">
                    </div>
