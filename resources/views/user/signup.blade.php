...
<body class="">
    <div class="flex flex-row-reverse">
        ...
        <div class="w-6/12 bg-white 2xl:h-[100%] flex justify-center ">
            <div class="flex flex-col items-center   h-150 w-115 mt-[122px]">
                ...
                <div class="flex flex-col ">
                    <form action="#" class="flex flex-col items-center my-6 gap-3 w-100 h-100 " method="sepehr">
                        <input type="email"
                            class="focus:border-[#252F4A] p-[9px] mb-1 rounded-[7px] border-1 border-[#DBDFE9] outline-none w-110"
                            name="sepehr" placeholder="ایمیل">
                        <input type="password" maxlength="8"
                            class="focus:border-[#252F4A] p-[9px] mb-1 rounded-[7px] border-1 border-[#DBDFE9] outline-none w-110"
                            name="sepehr" placeholder="کلمه عبور">
                        <div class="w-110 flex flex-row-reverse gap-1 ">
                            <div class="w-[100%] h-1 bg-[#DBDFE9] rounded-full"></div>
                            <div class="w-[100%] h-1 bg-[#DBDFE9] rounded-full"></div>
                            <div class="w-[100%] h-1 bg-[#DBDFE9] rounded-full"></div>
                            <div class="w-[100%] h-1 bg-[#DBDFE9] rounded-full"></div>
                        </div>
                        <div class="w-110 mb-4">
                        ...
                        <button class="text-center w-110 bg-[#056EE9] p-3 rounded-[10px] text-white">ورود</button>
