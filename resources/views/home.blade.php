        ...
        <section>
            ...
            <div class="my-3">
                ...
                <div class="w-full grid grid-cols-3 gap-3 mt-7">
                    ...
                    <a href="#" class="flex flex-col items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-10" viewBox="0 0 640 512">
                    ...
                    <a href="#" class="flex flex-col items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-10" viewBox="0 0 576 512">
                    ...
                    <a href="#" class="flex flex-col items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-10" viewBox="0 0 384 512">
