...
@section('content')
    <style>
        ...
        .qrcode {
            background: linear-gradient(0deg, rgb(203, 98, 142) 31%, rgb(173, 62, 99) 80%);
        }
        ...
        @keyframes pastelColorShift {
            0% {
                background-color: #FFB7B2;
                box-shadow: 0 2px 5px rgba(255, 183, 178, 0.3);
            }

            20% {
                background-color: #FFDAC1;
                box-shadow: 0 2px 5px rgba(255, 218, 193, 0.3);
            }

            40% {
                background-color: #E2F0CB;
                box-shadow: 0 2px 5px rgba(226, 240, 203, 0.3);
            }

            60% {
                background-color: #B5EAD7;
                box-shadow: 0 2px 5px rgba(181, 234, 215, 0.3);
            }

            80% {
                background-color: #C7CEEA;
                box-shadow: 0 2px 5px rgba(199, 206, 234, 0.3);
            }
        ...
        <section>
                ...
                <div class="w-full grid grid-cols-4 gap-3 mt-4">
                    ...
                    <a href="#"
                        ...
                        <div class="rounded-lg size-14 computer flex justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-10 fill-white" viewBox="0 0 640 512">
                                <path
                                    d="M384 64c17.7 0 32 14.3 32 32V320c0 17.7-14.3 32-32 32H275.5 264 184 172.5 64c-17.7 0-32-14.3-32-32V96c0-17.7 14.3-32 32-32H384zM64 384h97.8l-21.3 64H80c-8.8 0-16 7.2-16 16s7.2 16 16 16h49.8H152 296h22.2H368c8.8 0 16-7.2 16-16s-7.2-16-16-16H307.5l-21.3-64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64C28.7 32 0 60.7 0 96V320c0 35.3 28.7 64 64 64zm110.2 64l21.3-64h56.9l21.3 64H174.2zM528 64h64c8.8 0 16 7.2 16 16v48H512V80c0-8.8 7.2-16 16-16zm-16 96h96v32H512V160zm0 272V224h96V432c0 8.8-7.2 16-16 16H528c-8.8 0-16-7.2-16-16zM480 80V432c0 26.5 21.5 48 48 48h64c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48H528c-26.5 0-48 21.5-48 48zm80 280a24 24 0 1 0 0-48 24 24 0 1 0 0 48z" />
                            </svg>
                        </div>
                        <span class="text-sm font-bold text-gray-800 text-center">
                            خدمات کامپیوتر
            ...
            <div class="my-3 bg-white p-5 rounded-[20px] w-[95%] mx-auto">
                ...
                <div class="flex flex-row justify-between items-center gap-1.5">
                    ...
                    <h3 class="lg:text-xl text-sm font-bold">آموزش</h3>
                            ...
                            @if (count($page->socialMedia))
                                <a href="{{ route('client.loadLink', [$page->id]) }}"
                                    ...
                                    <div class="w-full">
                                        ...
                                        <span
                                            class="w-20 inline-block text-xs font-medium text-center min-h-8 max-h-8">{{ $page->title }}</span>
            ...
            <div class="bg-white p-5 rounded-[20px] w-[95%] mx-auto my-3">
                ...
                <div class="flex flex-row gap-3 py-4 overflow-x-auto overflow-y-clip">
                    <div class="flex flex-col gap-1 pb-4 justify-center items-center cursor-pointer careerCat relative"
                        ...
                        <div class="size-20 rounded-md border border-gray-300 p-2 overflow-hidden">
                            <img class="h-full w-full rounded-lg object-cover" src="{{ asset('assets/img/all.png') }}"
            ...
            <div class="bg-white p-5 rounded-[20px] w-[95%] mx-auto my-3">
                ...
                <div class="w-full gap-2 flex flex-row overflow-auto " id="favorite_section">
                    ...
                    <div class="fixed w-full h-dvh bg-black/50 flex justify-center items-center top-0 right-0 z-40 invisible opacity-0 form"
                        id="openFavorite">
                        <div
                            class="w-2/4 h-2/3 overflow-y-auto [&::-webkit-scrollbar]:hidden bg-white rounded-lg flex flex-row justify-center items-start p-4 gap-4">
