...
<body class="bg-[#ffffff]">
    <header>
        {{-- mobile menu --}}
        <div class="w-full px-3 py-2.5 bg-[#eb3254] lg:hidden">
    ...
    <div class="lg:hidden w-full fixed bottom-0 bg-white right-0">
        <div class="w-full flex flex-row justify-center">
            <ul class="w-full mx-auto flex flex-row justify-between items-center bg-white border-t-1 border-gray-300 p-2">
                <li>
                    {{-- category --}}
