            ...
            <div class="w-full flex flex-col gap-3 p-3 border border-gray-300 rounded-lg">
                ...
                <div class="w-full lg:w-10/12 m-auto">
                    ...
                    <div class="w-full flex flex-col overflow-x-auto scroll-snap-x snap-mandatory gap-3 px-1 py-2 no-scrollbar ">
                        ...
                        <div class="shrink-0 snap-center lg:pr-5 grid grid-cols-4 gap-4">
                            ...
                            <div class="shrink-0 text-xs lg:text-base snap-center py-1 text-gray-600 flex flex-row justify-center items-center border border-gray-400 rounded-[7px] p-3">{{ $value->price }}</div>
                            <div class="shrink-0 text-xs lg:text-base snap-center py-1 text-gray-600 flex flex-row justify-center items-center border border-gray-400 rounded-[7px] p-3">{{ $value->description }}</div>
                            <div class="py-1">
