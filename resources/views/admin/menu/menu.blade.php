    ...
    <div class="2xl:container mx-auto w-10/12">
        <div class="w-full py-5 mt-5 rounded-[10px]">
            <div class="flex flex-row-reverse justify-between">
                ...
                <h1 class="font-bold py-5 text-gray-500 lg:text-2xl
                                                        md:text-xl ">
            ...
            <div class="w-full flex flex-col gap-3 p-3 border border-gray-300 rounded-lg">
                ...
                <div class="w-10/12 m-auto">
                    ...
                    <div class="w-full flex flex-col overflow-x-auto scroll-snap-x snap-mandatory gap-3 px-1 py-2 no-scrollbar ">
                        ...
                        <div class="flex-shrink-0 snap-center pr-5 grid grid-cols-4 gap-4">
                            <div class=" snap-cente py-1 text-gray-600 flex flex-row justify-center items-center border border-gray-400 rounded-[7px] p-3">{{ $value->title }}</div>
                            <div class="flex-shrink-0 snap-center py-1 text-gray-600 flex flex-row justify-center items-center border border-gray-400 rounded-[7px] p-3">{{ $value->price }}</div>
                            <div class="flex-shrink-0 snap-center py-1 text-gray-600 flex flex-row justify-center items-center border border-gray-400 rounded-[7px] p-3">{{ $value->description }}</div>
                            <div class="py-1">
