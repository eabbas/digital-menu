...
@section('content')
    <div class="flex flex-col w-full mb-3">
        ...
        <form action="{{ route('menuCat.deleteAll') }}" method="post" class="flex flex-col p-2 lg:p-5 gap-3 shadow__profaill__list_products rounded-[7px] bg-white">
            ...
            <div class="w-11/12 lg:w-2/3 mx-auto flex flex-row justify-between items-center py-3">
            ...
            <div class="lg:p-3">
                <div class="w-11/12 lg:w-2/3 m-auto overflow-x-auto [&::-webkit-scrollbar]:hidden lg:overflow-visible">
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-24 lg:w-full">نام دسته</span>
                        </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="w-10 lg:w-full">
                                        <input type="checkbox" class="check" name="menuCats[]" value="{{ $category->id }}">
                                    </div>
                                </div>
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                ...
                                <div class="col-span-6">
                                    <div
                                        class="lg:w-full grid grid-cols-3 divide-x divide-[#f1f1f4] items-center w-[190px]">
