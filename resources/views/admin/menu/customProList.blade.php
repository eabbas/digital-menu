...
@section('content')
    ...
    <div class="w-full min-h-screen pb-10 pt-6 bg-gradient-to-b from-blue-50 to-white">
        <div class="w-11/12 mx-auto">
            ...
            <div class="fixed w-full h-dvh z-999 top-0 right-0 bg-black/50 invisible opacity-0 transition-all duration-300 form"
                id="createCPform">
                <div class="w-[calc(100%-265px)] float-end flex justify-center items-center bg-white h-dvh relative"
                    id="closeCreateCPform">
                    <span
                        class="cursor-pointer absolute top-4 right-4 text-4xl text-gray-500 hover:text-gray-700 transition-colors duration-200"
                    ...
                    <form action="{{ route('cp.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <div
                                class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition duration-200">
                                <div class="space-y-1 text-center">
                                    <i class="fas fa-cloud-upload-alt text-3xl text-gray-400 mx-auto"></i>
                                    <div class="flex text-sm text-gray-600">
                                        <label for="customProductImage"
                                            class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                                            <span>آپلود فایل</span>
                                            <input id="customProductImage" name="customProductImage" type="file"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="material_limit" id="material_limit"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200"
                                placeholder="محدودیت متریال را وارد کنید" required>
                        </div>
                                        ...
                                        <div class="col-span-6">
                                            <div
                                                ...
                                                <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3 gap-4">
                                                    ...
                                                    <li class="flex justify-center"
                                                        onclick='editCP("{{ $custom_product->id }}")'>
    ...
    @if (isset($custom_product))
        <div class="fixed w-full h-dvh z-999 top-0 right-0 bg-black/50 invisible opacity-0 transition-all duration-300 form"
            id="editCPform">
            <div class="w-[calc(100%-265px)] float-end flex justify-center items-center h-dvh relative bg-white"
                id="closeEditCform">
                <div class="cursor-pointer absolute top-4 right-4 text-4xl close_icon hover:bg-red-500 bg-white size-8 rounded-full flex items-center justify-center transition-all duration-200"
                    onclick="closeForm()">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 384 512">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 lg:gap-4">
                        <div class="w-full flex flex-col">
                            <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] sm:py-1 pr-3"
                                for="title">
                                <legend
                                    class="p-1 w-20 sm:bg-blue-400 sm:text-white rounded-full flex flex-row justify-center text-sm">
                                    عنوان
                                </legend>
                                <input type="title" name="editTitleCP" id="editTitleCP"
                                    value="{{ $custom_product->title }}"
                        ...
                        <div class="w-full flex flex-col">
                            <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] sm:py-1 pr-3"
                                ...
                                <legend
                                    class="p-1 w-20 sm:bg-blue-400 sm:text-white rounded-full flex flex-row justify-center text-sm">
                                    توضیحات</legend>
                                <input type="description" name="description" id="editDescriptionCP"
                                    value="{{ $custom_product->description }}"
                                    class="w-full px-2 py-1 lg:px-2 outline-none text-gray-500">
                            </fieldset>
                        </div>
                        ...
                        <div class="w-full flex flex-col">
                            <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] sm:py-1 pr-3"
                                ...
                                <legend
                                    class="p-1 w-20 sm:bg-blue-400 sm:text-white rounded-full flex flex-row justify-center text-sm">
                                    حد مواد </legend>
                                <input type="material_limit" name="material_limit" id="material_limit_CP"
                                    value="{{ $custom_product->material_limit }}"
                                    class="w-full px-2 py-1 lg:px-2 outline-none text-gray-500">
                            </fieldset>
                        </div>
                    </div>
