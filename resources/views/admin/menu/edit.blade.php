...
<div class="w-full h-full bg-cover bg-no-repeat pb-10">
        <h2 class="text-xl lg:text-3xl text-center font-bold py-5 text-[#425A8B]">  ویرایش {{ $menu->title }}</h2>
                    ...
                    <div class="bg-white rounded-2xl shadow-md p-3 w-full">
                        <div class="text-center mb-4">
                            ...
                            <div class="w-full text-left ">
                                <button type="submit"
                                    class="w-24 active:bg-[#0080e5] mt-2 bg-[#03A9F4] text-white p-3 max-md:p-2 rounded-md hover:bg-blue-700 transition duration-200 font-medium cursor-pointer">
                                    ثبت
                                </button>
                            </div>
                        </div>
