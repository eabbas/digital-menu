        ...
        <div class="flex flex-col p-6 gap-3 shadow__profaill__list_products rounded-[7px] bg-white">
            ...
            <div class="p-3">
                <table class="w-2/3 m-auto">
                    <thead>
                        <tr>
                            <td class="py-3 text-sm text-gray-500 text-center">ردیف</td>
                            <td class="py-3 text-sm text-gray-500 text-center">تصویر</td>
                            <td class="py-3 text-sm text-gray-500 text-center">عنوان </td>
                            <td class="py-3 text-sm text-gray-500 text-center">توضیحات </td>
                            <td class="py-3 text-sm text-gray-500 text-center">دسته</td>
                            <td class="py-3 text-sm text-gray-500 text-center"></td>
                            </td>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="divide-x divide-[#f1f1f4]">
                            ...
                            <td class="text-sm text-center">{{ $item->title }}</td>
                            <td class="text-sm text-center">{{ $item->description }}</td>
                            <td class="text-sm text-center">{{ $item->menu_category->title }}</td>
                            <td>
                                <ul class="text-sm grid grid-cols-3 items-center mt-1 rounded-sm p-1">
                                   
                                    <li class="flex justify-center">
                                        <a href="{{ route('menuItem.single', [$item->id]) }}" class="w-fit flex flex-row items-center justify-center bg-blue-500 hover:bg-blue-600 p-1 rounded-sm" title="مشاهده">
                                    ...
                                    <li class="flex justify-center">
                                        <a href="{{ route('menuItem.edit', [$item->id]) }}" class="w-fit flex flex-row items-center justify-center bg-green-500 hover:bg-green-600 p-1 rounded-sm" title="ویرایش">
                                    ...
                                    <li class="flex justify-center">
                                        <a href="{{ route('menuItem.delete', [$item->id]) }}" class="w-fit flex flex-row items-center justify-center bg-red-500 hover:bg-red-600 p-1 rounded-sm" title="حذف">
                            ...
                            @if($item->parent_id == 0)
                            <td>
                                <a href="{{ route('menuItem.variants', [$item->id]) }}" class="block text-center hover:text-blue-800 p-1 rounded-sm text-gray-700">ایجاد نوع دیگر</a>
                            </td>
                            @endif
                        </tr>
                        @php
