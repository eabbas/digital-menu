...
@section('title', ' همه فروشگاه ها')
@section('content')
<div class="w-full flex flex-col pb-4">
    <div class="bg-white rounded-lg">

        <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست فروشگاه ها</h2>

        <form class="flex flex-col gap-5" action="{{ route('ecomm.deleteAll') }}" method="post">
            @csrf
            ...
            <div
                ...
                <div class="bg-white divide-y divide-[#f1f1f4]">
                    ...
                    @endphp
                    @if ($ecomms)
                        @foreach ($ecomms as $ecomm)
                            
                            @if ($ecomm)
                              @php $hasEcomm=true; @endphp
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="w-10 lg:w-full">
                                            <input type="checkbox" class="check" name="ecomms[]" value="{{ $ecomm->id }}">
                                        </div>
                                    </div>
                                    <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                    ...
                                    <div
                                        ...
                                        <div class="w-20 lg:w-full">
                                            <img class="max-w-[50px] max-h-[50px] mx-auto size-12 object-cover rounded-md"
                                                 src="{{ asset('storage/' . $ecomm->logo) }}">
                                        </div>
                                    </div>
                                    <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                        <a href="{{ route('ecomm.single', [$ecomm->id]) }}"
                                           class="block w-20 lg:w-full">{{ $ecomm->title }}</a>
                                    </div>
                                    <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                        <a href="{{ route('user.show', [$ecomm->user->id]) }}"
                                           class="block w-30 lg:w-full">{{ $ecomm->user->name }}
                                            {{ $ecomm->user->family }}</a>
                                    </div>
                                    <div class="col-span-4">
                                        <div
                                            ...
                                            <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                                ...
                                                <li class="flex justify-center">
                                                    <a href="{{ route('ecomm.edit', [$ecomm->id]) }}"
                                                ...
                                                <li class="flex justify-center">
                                                    <a href="{{ route('ecomm.delete', [$ecomm->id]) }}"
                                            ...
                                            <div
                                                ...
                                                <a href="{{ route('ecomm_category.ecomm_categories', [$ecomm->id]) }}"
                                                   class="text-sky-700">دسته ها</a>
                                            </div>

                                                <div
                                                        class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
                                                    <a href="{{ route('ecomm.ecomm_menu', [$ecomm->id]) }}"
                                                       class="text-sky-700">منو ها</a>
                                                </div>
                                        </div>
                                    </div>
                                </div>
