                                ...
                                @if ($ecomm)
                                    <div
                                        ...
                                        <div class="w-full col-span-3">
                                            <div
                                                class="grid grid-cols-5 h-full divide-x divide-[#f1f1f4] w-60 lg:w-full">
                                                <div
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{route('ecomm_category.ecomm_categories',[$ecomm])}}"
                                                         class="transition-all duration-150 hover:text-sky-400   hover:border-teal-500"> دسته بندی محصولات</a>
                                                </div>
                                                <div
                                                    class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
                                                ...
                                                @if (!$ecomm->menu)
                                                    <div
                                                        class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
                                                        <a href="vcv{vvvv{ nnroute(ffff'menu.create', [$ecomm]) }}"
                                                             class="transition-all duration-150 hover:text-sky-400   hover:border-teal-500">ایجاد منو</a>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
