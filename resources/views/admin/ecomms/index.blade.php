...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست فرشگاه ها </h2>
            ...
            <div class="flex flex-col gap-5">
                <div class="w-10/12 mx-auto bg-gray-100 shadow-md rounded mb-5">
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">نام صاحب فروشگاه</span>
                        </div>
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                        ...
                        @foreach ($ecomms as $ecomm)
                            <div class="w-full flex flex-row lg:grid lg:grid-cols-10 items-center divide-x divide-[#f1f1f4]">
                                ...
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                    <span class="block w-20 lg:w-full">{{ $ecomm->user->name }} {{ $ecomm->user->family }}</span>
                                </div>
                                <div class="col-span-4 grid grid-cols-3 divide-x divide-[#f1f1f4] items-center">
                                    <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('ecomm.delete', [$ecomm]) }}"
                                    ...
                                    @if ($ecomm->menu_categories)
                                        <div
                                            ...
                                            <a href="{{ route('menuCat.list') }}"
                                                class="text-sm text-blue-500 hover:text-blue-600">مشاهده دسته بندی
                                                منو</a>
                                        </div>
                                    @else
                                        <div
                                            ...
                                            <a href="{{ route('ecomm.ecomm_menu', [$ecomm]) }}"
                                                class="text-sm text-blue-500 hover:text-blue-600">مشاهده منو</a>
                                        </div>
                                        <div
                                            class="p-1 lg:p-3 text-center lg:text-sm h-full flex items-center justify-center font-medium">
