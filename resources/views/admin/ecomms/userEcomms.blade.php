...
@section('title', 'فروشگاه های من')

@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">

            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست فروشگاه های من</h2>
            @if (count(Auth::user()->ecomms))
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-5">
                                <span class="block w-[400px] lg:w-full">عملیات</span>
                            </div>
                        ...
                        <div class="bg-white divide-y divide-[#f1f1f4]">
                            ...
                            @endphp
                                ...
                                @foreach (Auth::user()->ecomms as $ecomm)
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="w-10 lg:w-full">
                                                    <input type="checkbox" class="check" name="ecomms[]"
                                                           value="{{ $ecomm->id }}">
                                                </div>
                                            </div>
                                            <div
                                            ...
                                            <div
                                                ...
                                                <a href="{{ route('ecomm.single', [$ecomm->id]) }}"><span class="block w-20 lg:w-full">{{ $ecomm->title }}</span></a>
                                            </div>
                                            <div class="col-span-5">
                                                <div class="lg:w-full grid grid-cols-4 divide-x divide-[#f1f1f4] items-center w-[400px]">
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="{{ route('ecomm_category.create') }}"
                                                           class="text-sky-700">دسته جدید</a>
                                                    </div>
                ...
                @else
                    <div class="w-full flex flex-col items-center gap-5 pb-5">
                        <a href="{{ route('ecomm.create') }}" class="font-bold text-blue-500 hover:text-blue-600 py-3">فروشگاه جدید</a>
