            ...
            <div class="overflow-x-auto shadow-md" style="scrollbar-width: none;">
                <div class="min-w-full bg-gray-200">
                    <div class="bg-gray-100 grid grid-cols-8 items-center divide-x divide-[#f1f1f4]">
                        ...
                        <div class="px-6 py-3 text-center text-xs font-medium text-gray-600"> نام دسته بندی   </div>
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                        ...
                        <div class="grid grid-cols-8 items-center divide-x divide-[#f1f1f4]">
                            ...
                            <div class="p-3 text-sm h-full flex items-center justify-center text-gray-900">{{ $cpm->max_unit_amount}}</div>
                            ...
                            @endif
                            @if($cpm->category_id)
                            <div class="p-3 text-sm h-full flex items-center justify-center text-gray-900">{{ $cpm->customCategory->title }}</div>
                            @endif
