...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست دانش آموزان آموزشگاه {{$institute->title}}</h2>
                                ...
                                <div class="flex items-center justify-center col-span-3">
                                     <div class="w-[270px] grid grid-cols-2 divide-x divide-[#f1f1f4] items-center">
                                         <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                             ...
                                             <li class="flex justify-center">
                                                 <a href="{{ route('institute.student_delete', [$student]) }}"
                                         ...
                                         <div
                                             ...
                                             <a href="{{ route('institute.master_classes', [$student]) }}" class="text-sky-700">کلاس ها</a>
                                         </div>
                                    </div>
                                 </div>
                            </div>
