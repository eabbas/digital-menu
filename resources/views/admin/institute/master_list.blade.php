...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست اساتید آموزشگاه {{$institute->title}}</h2>
                        ...
                        @if($institute)
                            @foreach ($institute->masters as $master)
                                ...
                                <div class="w-10 lg:w-full">
                                    <input type="checkbox" class="check" name="institutes[]" value="{{ $master->id }}">
                                </div>
                            </div>
                            <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                        ...
                                        <div
                                            ...
                                            <div class="w-20 lg:w-full">
                                             ...
                                             <img class="max-w-[50px] max-h-[50px] mx-auto size-12 object-cover rounded-md"
                                                 src="{{ asset('storage/' . $master->main_image) }}">
                                                @endif
                                                @if (!$master->main_image)
                                             <img class="max-w-[50px] max-h-[50px] mx-auto size-12 object-cover rounded-md"
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('user.show', [$master->id]) }}"
                                                class="block w-20 lg:w-full">{{ $master->name }} {{$master->family}}</a>
                                        </div>
                                        <div
                                        ...
                                        <span class="block w-24 lg:w-full">{{ $master->phoneNumber }}</span>
                                        </div>
                                ...
                                <div class="flex items-center justify-center col-span-3">
                                     <div class="w-[270px] grid grid-cols-2 divide-x divide-[#f1f1f4] items-center">
                                         <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                             ...
                                             <li class="flex justify-center">
                                                 <a href="{{ route('institute.master_delete', [$master]) }}"
                                         ...
                                         <div
                                             ...
                                             <a href="{{ route('institute.master_classes', [$master]) }}" class="text-sky-700">کلاس ها</a>
                                         </div>
                                    </div>
                                 </div>
                            </div>
