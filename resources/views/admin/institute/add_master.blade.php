    ...
    <div class="flex flex-col items-center justify-center mt-30 gap-3">
        <div class="text-center mb-4">
            <h1 class="text-lg font-bold text-gray-800">
                  افزودن استاد به آموزشگاه {{$institute->title}}
            </h1>
        </div>
        <form action="{{ route('institute.master_store') }}" method="post" enctype='multipart/form-data'>
            @csrf
    ...
    @elseif($institute->master)
    <div class="flex flex-col items-center justify-center mt-30 gap-3">
        <div class="text-center mb-4">
            <h1 class="text-lg font-bold text-gray-800">
                  شما قبلا برای  این آموزشگاه {{$institute->title}} استاد اضافه کرده اید.
            </h1>
        </div>
