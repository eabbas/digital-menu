...
@section('title', 'شعبه ها')
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">

            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست شعبه های آموزشگاه {{$institute->title}}</h2>

            <form class="flex flex-col gap-5" action="{{ route('institute.deleteAll') }}" method="post">
                @csrf
                ...
                <div
                    ...
                    <div
                        class="w-full flex flex-row lg:grid lg:grid-cols-14 items-center divide-x divide-[#f1f1f4] sticky -top-5">
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-30 lg:w-full">صاحب آموزشگاه</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                        @php
                            $i = 1;
                        @endphp
                        @if($institute->children)
                        {{-- @dd($institute->children) --}}
                            @foreach ($institute->children as $branch)
                                <div
                                class="w-full flex flex-row lg:grid lg:grid-cols-14 items-center divide-x divide-[#f1f1f4]">
                                <div
                                ...
                                <div class="w-10 lg:w-full">
                                    <input type="checkbox" class="check" name="institutes[]" value="{{ $branch->id }}">
                                </div>
                            </div>
                            <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                        ...
                                        <span class="block w-30 lg:w-full">{{ $branch->title }}</span>
                                        </div> --}}
                                        <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                            <a href="{{ route('institute.single', [$branch->id]) }}"
                                                class="block w-20 lg:w-full">{{ $branch->title }}</a>
                                        </div>
                                        <div
                                        class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                        <a href="{{ route('user.show', [$branch->user_id]) }}"
                                            class="block w-30 lg:w-full">{{ $branch->owner->name }}
                                            {{ $branch->owner->family }}</a>
                                        </div>
                                        <div
                                         class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 w-[500px] lg:w-full text-center col-span-2">
                                        <span class="block w-24 lg:w-full">{{ $branch->phone }}</span>
                                        </div>
                                 ...
                                 <div class="col-span-5">
                                    ...
                                    <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                        <li class="flex justify-center">
                                            <a href="{{ route('institute.single', [$branch]) }}"
                                  ...
                                  <li class="flex justify-center">
                                    <a href="{{ route('institute.edit', [$branch]) }}"
                        ...
                        <li class="flex justify-center">
                            <a href="{{ route('institute.delete', [$branch]) }}"
            ...
            <div
                        class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
                            <a href="{{ route('field.create', [$branch]) }}"
                                class="text-sky-700">ایجاد رشته</a>
                        </div>
                        <div
                            class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium text-nowrap">
                            <a href="{{ route('lesson.create', [$branch]) }}"
                            class="text-sky-700">ایجاد درس</a>
                        </div>
                        <div
                            class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium text-nowrap">
                            <a href="{{ route('class.create', [$branch]) }}"
                            class="text-sky-700">ایجاد کلاس</a>
                        </div>
                    </div>
                    </div>
                        </div>
