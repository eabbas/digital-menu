...
{{--                                @if ($users[$i])--}}
{{--                                    <div class="checklist-item w-full flex flex-col sm:flex-row justify-between items-stretch sm:items-center px-3 sm:px-4 py-3 sm:py-3 relative">--}}

{{--                                        <!-- ID Badge for mobile -->--}}
{{--                                        <div class="checklist-id-badge sm:hidden">--}}
{{--                                            <span class="text-xs text-gray-500">#{{$users[$i]->id}}</span>--}}
{{--                                        </div>--}}

{{--                                        <!-- ID for desktop -->--}}
{{--                                        <span class="hidden sm:block text-sm text-gray-500 w-12">{{$users[$i]->id}}</span>--}}

{{--                                        <div class="flex-1 flex flex-col lg:flex-row gap-3">--}}
{{--                                            <div class="user-section flex flex-col lg:flex-row  items-center justify-center sm:justify-start gap-3 py-2 sm:py-2">--}}
{{--                                                <!-- لوگو -->--}}
{{--                                                <div class="text-sm h-full flex items-center justify-center text-gray-900">--}}
{{--                                                    @if($users[$i]->main_image)--}}
{{--                                                        <img class="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full object-cover border border-gray-100 shadow-sm"--}}
{{--                                                             src="{{ asset('storage/' . $users[$i]->main_image) }}">--}}
{{--                                                    @else--}}
{{--                                                        <img class="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-full object-cover border border-gray-100 shadow-sm"--}}
...
{{--                                                <div class="date-section text-sm h-full flex flex-col lg:flex-row items-center justify-center gap-2 sm:gap-3 text-gray-900">--}}
{{--                                                <span class="inline-flex items-center gap-1">--}}
{{--                                                    <span class="text-rose-400 font-bold text-xs sm:text-sm">نام:</span>--}}
{{--                                                    <span class="text-xs sm:text-sm">{{ $users[$i]->name .' '.$users[$i]->family }}</span>--}}
{{--                                                </span>--}}
...
{{--                                        <!-- دکمه‌های عملیات -->--}}
{{--                                        <div class="action-buttons-mobile flex flex-row justify-center items-center gap-2 mt-2 sm:mt-0">--}}
{{--                                            <!-- دکمه‌های دسکتاپ (لینک متنی) -->--}}



{{--                                            <div class="hidden sm:flex gap-3">--}}
{{--                                                <a href="{{ route('checkList.userChekList', $users[$i]->id) }}"--}}
{{--                                                   class="text-blue-600 hover:text-blue-700 text-sm font-medium transition">نمایش</a>--}}
{{--                                                <a href="{{route('checkList.deleteChecklist', $users[$i]->id) }}"--}}
...
{{--                                                <a href="{{route('checkList.deleteChecklist', $users[$i]->id) }}"--}}
{{--                                                   class="w-8 h-8 flex items-center justify-center bg-red-500 hover:bg-red-600 rounded-md transition shadow-sm"--}}
{{--                                                   title="حذف"--}}
...
{{--                                                </a>--}}
{{--                                                <a href="{{route('checkList.userChekList', $users[$i]->id) }}"--}}
{{--                                                   class="w-8 h-8 flex items-center justify-center bg-sky-500 hover:bg-sky-600 rounded-md transition shadow-sm"--}}
{{--                                                   title="مشاهده">--}}
                                ...
                                @if ($users[$i])
                                    <div class="checklist-item w-full flex  justify-between items-center px-3 sm:px-4 py-3 sm:py-3 relative">
                                        ...
                                        {{--                                        </div>--}}
                                            ...
                                            <!-- ID for desktop -->
                                        <span class=" text-sm text-gray-500 w-5">{{$users[$i]->id}}</span>
                                        ...
                                        <div class=" flex flex-row justify-center items-center gap-2 ">
                                            ...
                                            <div class="hidden sm:flex gap-3">
                                                <a href="{{route('checkList.userChekList', $users[$i]->id) }}"
                                                   class="text-blue-600 hover:text-blue-700 text-sm font-medium transition"> مشاهده چکلیست های {{$users[$i]->name}}</a>
                                            ...
                                            <div class="flex sm:hidden gap-1">
                                                ...
                                                <a href="{{route('checkList.userChekList', $users[$i]->id) }}"
                                                   ...
                                                   title=" مشاهده چکلیست های {{$users[$i]->name}}">
