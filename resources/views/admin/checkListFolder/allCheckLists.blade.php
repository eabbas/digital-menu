...
{{--                                                    @if($checkLists[$i]['user']->main_image)--}}
{{--                                                        <img class="size-10 rounded-full object-cover mx-auto"--}}
{{--                                                             src="{{ asset('storage/' . $checkLists[$i]['user']->main_image) }}">--}}
{{--                                                    @else--}}
{{--                                                        <img class="size-10 rounded-full object-cover mx-auto"--}}
...
{{--                                                <!-- عنوان -->--}}
{{--                                                <div--}}
{{--                                                        class="text-sm h-full flex gap-3 items-center justify-center text-gray-900 text-center">--}}
{{--                                                    <span class="text-rose-400 font-bold"> نام: </span>--}}
{{--                                                    <span>{{ $checkLists[$i]['user']->name .' '.$checkLists[$i]['user']->family }}</span>--}}
{{--                                                    <span class="text-rose-400 font-bold">تاریخ ثبت: </span>--}}
{{--                                                    <span>{{ $checkLists[$i]->updated_at}}</span>--}}
{{--                                                    <span class="text-rose-400 font-bold">تاریخ ویرایش: </span>--}}
{{--                                                    <span>{{$checkLists[$i]->created_at}}</span>--}}
{{--                                                </div>--}}
...
{{--                                                <a href="{{route('checkList.editChecklist',$checkLists[$i]->id) }}"--}}
{{--                                                   class="text-sky-700 text-sm block py-1">ویرایش</a>--}}
{{--                                            </div>--}}
{{--                                            <div class="lg:block hidden">--}}
{{--                                                <a href="{{route('checkList.deleteChecklist', $checkLists[$i]->id) }}"--}}
{{--                                                   class="text-sky-700 text-sm block py-1">حذف</a>--}}
{{--                                            </div>--}}
{{--                                            <div class="lg:block hidden">--}}
{{--                                                <a href="{{route('checkList.singlecheckList', $checkLists[$i]->id) }}"--}}
{{--                                                   class="text-sky-700 text-sm block py-1">نمایش</a>--}}
{{--                                            </div>--}}
...
{{--                    هنوز هیچ چک لیستی ایجاد نکرده اید!--}}
{{--                </span>--}}
                            ...
                            @for ($i=0 ; $i<count($checkLists) ; $i++)
                                @if ($checkLists[$i])
                                    <div class="checklist-item w-full flex  justify-between items-center px-3 sm:px-4 py-3 sm:py-3 relative">
                                        ...
                                        <!-- ID for desktop -->
                                        <span class=" text-sm text-gray-500 w-5">{{$checkLists[$i]->id}}</span>
                                        ...
                                        <div class="flex-1 flex  gap-3">
                                            <div class="user-section flex  text-center items-center justify-center gap-3 py-2 sm:py-2">
                                                ...
                                                <span class="inline-flex items-center gap-1">
                                                    ...
                                                    <span class="text-xs sm:text-sm">{{ $checkLists[$i]['user']->name .' '.$checkLists[$i]['user']->family }}</span>
                                                </span>
                                                    <span class="sm:inline-flex items-center gap-1 hidden  ">
                                                    <span class="text-rose-400 font-bold text-xs sm:text-sm">تاریخ ثبت:</span>
{{--                                                        @dd($checkLists[$i]['user'])--}}
                                                    <span class="text-xs sm:text-sm">{{ $checkLists[$i]->created_at }}</span>
                                                </span>
                                                </div>
                                            </div>
                                        </div>
