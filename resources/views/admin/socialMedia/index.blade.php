 ...
 @section('content')
     <div class="w-full flex flex-col pb-4">
         <form action="{{ route('socialMedia.deleteAll') }}" method="post" class="bg-white rounded-lg">
            @csrf
             <div class="pb-4">
                 <h2 class="text-lg text-center font-bold text-gray-800 p-2.5">شبکه های اجتماعی</h2>
             </div>
              <div class="w-10/12 lg:w-2/3 mx-auto flex flex-row justify-between items-center py-3">
             ...
             <div class="flex flex-col gap-5">
                 <div class="w-10/12 lg:w-2/3 mx-auto shadow-md rounded mb-5 overflow-x-auto [&::-webkit-scrollbar]:hidden">
                     <div
                         ...
                         <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                             <span class="block w-20 lg:w-full">آیکون</span>
                         </div>
                         <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                             <span class="block w-20 lg:w-full">عنوان</span>
                         </div>
                         <div
                             class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-4">
                             <span class="block w-30 lg:w-full">لینک</span>
                         </div>
                         <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                     ...
                     <div class="bg-white divide-y divide-[#f1f1f4]">
                         ...
                         @foreach ($socialMedias as $socialMedia)
                             <div
                                 ...
                                 <div
                                        class="text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                        <div class="w-10 lg:w-full">
                                            <input type="checkbox" class="check" name="socialMedias[]"
                                 ...
                                 <div
                                     ...
                                     <div class="w-20 lg:w-full">
                                         <img class="max-w-[50px] max-h-[50px] mx-auto size-12 object-cover rounded-md"
                                             src="{{ asset('storage/' . $socialMedia->icon_path) }}">
                                     </div>
                                 </div>
                                 <div
                                     class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                     <span class="block w-20 lg:w-full">{{ $socialMedia->title }}</span>
                                 </div>
                                 <div
                                     class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-4">
                                     <span class="block w-30 lg:w-full" dir="ltr">{{ $socialMedia->link }}</span>
                                 </div>


                                 <div class="col-span-2">
                                     <ul class="w-24 lg:w-full text-sm mt-1 rounded-sm p-1 grid grid-cols-2">
    
                                         <li class="flex justify-center">
                                             <a href="{{ route('socialMedia.edit', [$socialMedia]) }}"
                                         ...
                                         <li class="flex justify-center">
                                             <a href="{{ route('socialMedia.delete', [$socialMedia]) }}"
