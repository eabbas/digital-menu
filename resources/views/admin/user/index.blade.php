 ...
 @section('content')
     ...
     <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <form action="{{ route('user.deleteAll') }}" method="post" class="flex flex-col gap-5">
                @csrf
                <div class="w-11/12 mx-auto flex flex-row justify-start gap-3 samim mt-2">
                    <div class="bg-white flex flex-row rounded-[7px] items-center gap-2 px-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                        d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                    </svg>
                    <input class="outline-none py-2 bg-gray-100" type="text" name="search" placeholder=" نام خانوادگی را وارد کنید" id="searchUser">
                    </div>
                    <div class="size-10 flex justify-center items-center rounded-[7px] bg-blue-100 w-[60px] mr-2 cursor-pointer">
                        <a onclick="searchUser()">جستجو</a>
                    </div>
                </div>
                                    ...
                                    <div class="col-span-3">
                                        <div class="w-[270px] grid grid-cols-2 divide-x divide-[#f1f1f4] items-center">
                                            ...
                                            <div class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
                                                <a href="{{ route('career.careers', [$user->id]) }}" class="text-sky-700">کسب و کار ها</a>
                                            </div>
                                        </div>
        ...
        function searchUser(){
            ...
            $.ajax({
                ...
                info.innerHTML=`  <div
                                    ...
                                    <div
                                        class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                        <span class="block w-20 lg:w-full">${index + 1}</span>
                                    </div>
                                    <div
                                        class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900">
                                        <div class="w-20 lg:w-full">
    ...
    <script src="{{ asset('assets/js/checkAll.js') }}">
