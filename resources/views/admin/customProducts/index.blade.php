        ...
        <div class="bg-white rounded-xl shadow-lg border border-blue-100 overflow-hidden">
            ...
            {{-- <div class="bg-gradient-to-r from-blue-600 to-blue-500">
                <div class="flex flex-row items-center">
                    <div class="w-[180px] px-4 py-4 text-center text-sm font-semibold text-white col-span-2 border-l border-blue-400/30">
                    ...
                    <div class="w-[87px] px-4 py-4 text-center text-sm font-semibold text-white border-l border-blue-400/30">
                        <div class="flex items-center justify-center gap-2">
                            <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="w-[175px] px-4 py-4 text-center text-sm font-semibold text-white border-l border-blue-400/30 col-span-2">
                        <div class="flex items-center justify-center gap-2">
                            <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="w-[100px] px-4 py-4 text-center text-sm font-semibold text-white border-l border-blue-400/30 flex justify-center items-center">
                    ...
                    <div class="w-[150px] px-4 py-4 text-center text-sm font-semibold text-white col-span-2 border-l border-blue-400/30">
                        <div class="flex items-center justify-center gap-2">
                            <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="w-[300px] flex justify-center items-center px-4 py-4 text-center text-sm font-semibold text-white col-span-2 border-blue-400/30">
                        <div class="flex">
                            لینک ها
                        </div>
                    </div>
            ...
            {{-- <div class="divide-y divide-blue-50">
                <div class="flex flex-col gap-5" id="custom_product_section">
                    ...
                    <div class="grid grid-cols-[180px_87px_175px_100px_150px_300px] items-center hover:bg-blue-50/30 transition-all duration-200 {{ $index % 2 == 0 ? 'bg-white' : 'bg-blue-50/20' }} newParameters"  data-cp-id="{{ $custom_product->id }}">
                        <!-- نام محصول -->
                        <div class="px-4 py-4 text-center col-span-2">
                        ...
                        <!-- عکس محصول -->
                        <div class="px-4 text-center col-span-2">
                            <div class="flex justify-center">
                                <div class="relative">
                                    <img class="size-16 object-cover rounded-lg shadow-sm" 
                        ...
                        <div class="flex flex-row w-[300px] justify-center items-center">
                            <!-- ایجاد نوع محصول -->
            ...
            <div class="flex flex-col gap-5">
                <div class="w-11/12 mx-auto shadow-md rounded mb-5 overflow-x-auto [&::-webkit-scrollbar]:hidden lg:overflow-visible">
                    <div class="w-full flex flex-row lg:grid lg:grid-cols-12 items-center divide-x divide-[#f1f1f4] sticky -top-5">
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-6">
    ...
    function updateCP(ev){
        ...
        $.ajax({
            ...
            data : {
                ...
                'career_id' : "{{ $custom_product->career_id }}",
    ...
    function storeCP(ev){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                let empty = document.getElementById('no_products_message')
                if(empty){
                    empty.remove()
                }
                        ...
                        <div class="">
                            <div class="grid grid-cols-5 h-full">
                               <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3 gap-4">
                                ...
                                <!-- ایجاد نوع محصول -->
                                <div class="py-4 flex items-center justify-center">
                                    <div onclick='openCPVform("{{ $custom_product }}")'
                                       class="flex flex-col items-center gap-1 text-blue-600 hover:text-blue-700 transition-colors group">
                                ...
                                <div onclick='openCform("{{ $custom_product }}")'
                                   class="text-indigo-600 hover:text-indigo-800 text-sm font-medium transition-colors">
                                    ایجاد دسته
                                </div>
                ...
                if(document.getElementById('no_products_message')) {
                    // حذف پیام "محصولی یافت نشد"
                    document.querySelector('.divide-y > div:last-child').remove();
                }
                closeForm()
                console.log(data)
            },
