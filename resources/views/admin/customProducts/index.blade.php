                ...
                <div class="min-w-full bg-gray-200">
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                        ...
                        <div class="grid grid-cols-8 items-center divide-x divide-[#f1f1f4]">
                            ...
                            <div class="p-3 text-sm h-full flex items-center justify-center text-gray-900">{{ $customProduct->duration}}</div>
                            ...
                            <div class="p-3 text-sm h-full flex items-center justify-center text-gray-900">{{ $customProduct->min_amount_unit}}</div>
