                ...
                <div
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]" id="custom_category_section">
                        ...
                        @foreach ($custom_product->customCategories as $category)
                            ...
                            <div class="w-full flex flex-row lg:grid lg:grid-cols-9 items-center divide-x divide-[#f1f1f4] newParameters"
                                data-cp-id="{{ $category->id }}">
                                <div
                                ...
                                <div
                                    class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 lg:w-full text-center">
                                    <span
                                        class="block w-11 lg:w-fit text-xs px-2 py-1 rounded {{ $category->required ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700' }}">
                                ...
                                <div class="col-span-4">
                                    <div
                                        class="lg:w-full grid grid-cols-3 divide-x divide-[#f1f1f4] items-center w-[320px]">
                                        ...
                                        <div onclick='openCPMform("{{ $category->id }}")'
                                            class="p-1 lg:p-3 text-xs text-center text-blue-600 h-full flex items-center justify-center font-medium cursor-pointer">
                                            ایجاد آیتم جدید
                                        </div>
                                        <div
                                            class="p-1 lg:p-3 text-xs text-center text-blue-600 h-full flex items-center justify-center font-medium">
            ...
            <div class="fixed w-full h-dvh z-999 top-0 right-0 bg-black/50 invisible opacity-0 transition-all duration-300 form"
                ...
                <div class="w-full lg:w-[calc(100%-265px)] float-end flex justify-center items-center h-dvh relative "
                    ...
                    <form action="{{ route('custmCategory.update') }}" method="post" enctype="multipart/form-data"
                        ...
                        <input type="hidden" name="custom_pro_id" id="custom_pro_id_cat"
                            value="{{ $category->custom_products->id }}">

                        <div class="mb-4">
                            <label for="editTitleCP" class="block text-sm font-medium mb-2">
                                عنوان
                            </label>
                            <input type="text" name="title" id="customCategoryTitle" required
                        ...
                        <div class="mb-4 flex flex-row items-center gap-3">
                            <input type="checkbox" name="required" id="customCategoryRequired"
                                value="{{ $category->required }}"
                                @if ($category->required) {{ 'checked' }} @endif>
                            <label for="editTitleCP" class="block text-sm font-medium mb-2">
                                لزوم
                            </label>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="max_item_amount" id="max_item_amount_category"
                                value="{{ $category->max_item_amount }}" required
            ...
            <div class="fixed w-full h-dvh z-999 top-0 right-0 bg-black/50 invisible opacity-0 transition-all duration-300 form"
                ...
                <div class="w-full lg:w-[calc(100%-265px)] float-end flex justify-center items-center h-dvh relative"
                    ...
                    <form action="{{ route('cpm.store') }}" method="post" enctype="multipart/form-data"
                        class="bg-white w-11/12 max-h-[calc(100vh-100px)] overflow-y-auto [&::-webkit-scrollbar]:hidden lg:w-1/2 p-5 rounded-lg">
                        @csrf
                        <div class="w-full grid grid-cols-1 lg:grid-cols-2 lg:gap-3">
                            <div class="mb-4">
                                ...
                                <input type="text" name="title" id="cpmtitle" required
                                    class="w-full p-2 border-1 rounded border-gray-300 focus:border-blue-500 focus:outline-none">
                            </div>
                            <div class="mb-4">
                                <label for="title" class="block text-sm font-medium mb-2">
                                ...
                                <input type="file" name="cpmImage" id="cpmImage" required
                                    class="w-full p-2 border-1 rounded border-gray-300 focus:border-blue-500 focus:outline-none">
                            </div>
                            <div>
                                ...
                                <input type="number" name="price_per_unit" id="cpm_price_per_unit" required
                                    min="0"
                                    class="w-full p-2 border-1 rounded border-gray-300 focus:border-blue-500 focus:outline-none">
                            </div>
                            <div class="flex items-center mt-3">
                                <input type="checkbox" name="required" id="cpmrequired" value="1" class="ml-2">
                            ...
                            <div>
                                ...
                                <input type="number" name="order" id="cpmorder" min="0" required
                                    class="w-full p-2 border-1 rounded border-gray-300 focus:border-blue-500 focus:outline-none">
                            </div>
                            <div class="space-y-4">
                                ...
                                <input type="number" name="max_unit_amount" id="cpm_max_unit_amount" min="1"
                                    required
                                    class="w-full p-2 border-1 rounded border-gray-300 focus:border-blue-500 focus:outline-none">
                            </div>
                            <div class="mb-4 lg:col-span-2">
                                ...
                                <textarea type="text" name="description" id="cpmdescription" required
    ...
    <script>
        ...
        function Categorystore(ev) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    // createCat.classList.add('hidden')
                    // createCat.classList.remove('flex')
                    ...
                    // div.classList =
                    //     "w-full flex flex-row lg:grid lg:grid-cols-9 items-center divide-x divide-[#f1f1f4] newParameters"
