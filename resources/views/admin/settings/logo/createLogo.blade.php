...
<body>
    ...
    <form action="{{route('settings.logo.upsertLogo')}}" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <div class="relative">
                <input type="file" name="logoImage" class="w-1/2 flex mx-auto px-4 py-3 pr-12 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200 bg-gray-50 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100">
