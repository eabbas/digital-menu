    ...
    @section('content')
        ...
        <form action="{{ route('classAttachment.update') }}" method="post" enctype='multipart/form-data'>
            @csrf
            <input type="hidden" name="id" value="{{ $classAttachment->id }}">
            <div class="min-h-screen flex items-start justify-center">
                <div class="bg-white rounded-2xl shadow-md p-3 w-full lg:w-3/4">
                    <div class="text-center mb-4">
                            <!-- بخش ویرایش کردن پیوست‌ها -->
                <div class="w-full lg:col-span-2 mt-8">
                    <h2 class="text-lg font-bold text-gray-800 mb-4">ویرایش پیوست</h2>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <div
                                    ...
                                    <select class="p-4 w-full focus:outline-none text-sm font-bold mr-2" name="lesson_class_id" id="lesson_class_id" type="number">
                                        ...
                                        <option value="{{$class->id}}" @if($class->id == $classAttachment->lesson_class->id) {{'selected'}} @endif>{{$class->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="flex flex-col lg:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="توضیحات کامل درباره این پیوست...">{{$classAttachment->description}}</textarea>
                                </div>
                            </div>
