...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست دانش آموزان کلاس {{$class->title}}</h2>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">نام دانش آموز</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                        ...
                        @if($class)
                            ...
                            {{-- @dd($class->students); --}}
                                ...
                                <div class="w-10 lg:w-full">
                                    <input type="checkbox" class="check" name="institutes[]" value="{{ $student->id }}">
                                </div>
                            </div>
                            <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('user.show', [$student->id]) }}"
                                                class="block w-20 lg:w-full">{{ $student->name }} {{$student->family}}</a>
                                        </div>
                                        <div
                                        ...
                                        <span class="block w-24 lg:w-full">{{ $student->phoneNumber }}</span>
                                        </div>
                                ...
                                <div class="flex items-center justify-center col-span-3">
                                     {{-- <div class="w-[270px] grid grid-cols-2 divide-x divide-[#f1f1f4] items-center"> --}}
                                         <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3 gap-8">
                                             <li class="flex justify-center">
                                                 <a href="{{ route('user.show', [$student]) }}"
                                             ...
                                             <li class="flex justify-center">
                                                 <a href="{{ route('user.edit', [$student]) }}"
                                             ...
                                             <li class="flex justify-center">
                                                 <a href="{{ route('class.student_delete', [$student]) }}"
                                         ...
                                         {{-- <div
                                             ...
                                             <a href="{{ route('class.master_classes', [$student]) }}" class="text-sky-700">کلاس ها</a>
                                         </div> --}}
                                    {{-- </div> --}}
                                 </div>
                            </div>
        ...
        @if (Auth::user()->role[0]->title == 'master')
        {{-- دکمه بازگشت --}}
        <div class="w-11/12 mx-auto pb-6 flex justify-end mt-3">
            <a href="{{ route('class.master_classes') }}"
