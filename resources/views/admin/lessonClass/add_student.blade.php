    ...
    <div class="flex flex-col items-center justify-center mt-30 gap-3">
        <div class="text-center mb-4">
            <h1 class="text-lg font-bold text-gray-800">
                  افزودن دانش آموز به درس {{$class->lesson->title}} (کلاس {{$class->title}})
            </h1>
        </div>
        <form action="{{ route('class.student_store') }}" method="post" enctype='multipart/form-data'>
            @csrf
                            ...
                            <div class="flex flex-col w-full itmes-center max-md:flex-col max-md:gap-1">
                                ...
                                <div
                                    ...
                                    <input class="p-4 w-full focus:outline-none text-sm font-bold mr-2" type="number"
                                        name='phone' placeholder="شماره تلفن دانش آموز را وارد کنید"required>
                                </div>
