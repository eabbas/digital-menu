...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست کلاس های من</h2>
            ...
            <form class="flex flex-col gap-5" action="{{ route('career.deleteAll') }}" method="post">
                ...
                <div class="w-11/12 mx-auto shadow-md rounded mb-5 overflow-x-auto [&::-webkit-scrollbar]:hidden lg:overflow-visible">
                    <div class="w-full flex flex-row lg:grid lg:grid-cols-12 items-center divide-x divide-[#f1f1f4] sticky -top-5">
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-30 lg:w-full">آموزشگاه</span>
                        </div>
                        {{-- <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                    ...
                    <div class="bg-white divide-y divide-[#f1f1f4]">
                        ...
                        @if($user->lesson_classes)
                        @foreach ($user->lesson_classes as $class)
                        {{-- @foreach ($class->lesson->field->institute as $institute) --}}
                        {{-- @dd($class->lesson->field->institute); --}}
                            {{-- @dd($institute->id); --}}
                            ...
                            <div class="w-full flex flex-row lg:grid lg:grid-cols-12 items-center divide-x divide-[#f1f1f4]">
                                ...
                                <div class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                    ...
                                    <div class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                        <a href="{{ route('lesson.single', [$class->lesson->field->institute->id]) }}"
                                            class="block w-20 lg:w-full">{{ $class->lesson->field->institute->title }}</a>
                                    </div>
                                        ...
                                        <div class="col-span-3">
                                            <div
                                            class=" w-full lg:w-full grid grid-cols-2 divide-x divide-[#f1f1f4] items-center">
                                    ...
                                    <a href="{{  route('class.student_list' ,[$class]) }}"
                                        class="text-sky-700">لیست دانش آموزان</a>
                                </div>
                                  </div>
                             </div>
                        </div>
