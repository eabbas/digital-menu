        ...
        <fieldset class="border-2 rounded-[10px] border-gray-400 shadow">
            ...
            <form action="{{ route('career.update')}}" method="post" enctype='multipart/form-data'
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-5 lg:gap-9">
                    <div class="w-full flex flex-col">
                        <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] py-1 pr-3"
                            for="title">
                            <legend class="p-1 w-20 bg-gray-200 rounded-full flex flex-row justify-center text-sm">عنوان
                            </legend>
                    ...
                    <div class="w-full flex flex-col">
                        <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] py-1 pr-3"
                            for="province">
                            <legend class="p-1 w-20 bg-gray-200 rounded-full flex flex-row justify-center text-sm">استان
                            </legend>
                    ...
                    <div class="w-full flex flex-col">
                        <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] py-1 pr-3"
                            for="city">
                            <legend class="p-1 w-20 bg-gray-200 rounded-full flex flex-row justify-center text-sm">شهر
                            </legend>
                    ...
                    <div class="w-full flex flex-col">
                        <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] py-1 pr-3"
                            for="address">
                            <legend class="p-1 w-20 bg-gray-200 rounded-full flex flex-row justify-center text-sm">ادرس
                            </legend>
                    ...
                    <div class="w-full flex flex-col">
                        <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] py-1 pr-3"
                            for="description">
                            <legend class="p-1 w-20 bg-gray-200 rounded-full flex flex-row justify-center text-sm">
                                توضیحات</legend>
                    ...
                    <div class="w-full flex flex-col">
                        <fieldset class="text-sm md:text-base border border-gray-400 rounded-[20px] py-1 pr-3"
                            for="email">
                            <legend class="p-1 w-20 bg-gray-200 rounded-full flex flex-row justify-center text-sm">ایمیل
                            </legend>
                ...
                <div class="text-center md:px-12 mt-5 lg:mt-10">
                    <button
                        class="max-sm:bg-gray-400 max-sm:text-white px-5 py-2 lg:px-10 lg:py-3 border-gray-400 border rounded-md transition-all duration-150 hover:bg-gray-400 hover:border-gray-400 hover:text-white text-gray-500 cursor-pointer">ثبت</button>
                </div>
            </form>
        </fieldset>
    </div>
