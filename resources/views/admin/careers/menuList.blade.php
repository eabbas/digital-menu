...
@section('content')
    ...
    <div class="w-full flex flex-col pb-4">
        <form action="{{ route('menu.deleteAll') }}" method="post" class="bg-white rounded-lg">
            ...
            <div class="w-10/12 mx-auto flex flex-row-reverse justify-between items-end py-4">
                <div>
            ...
            <div class="w-10/12 mx-auto flex flex-row justify-between items-center py-3">
            ...
            <div class="flex flex-col gap-5 mb-5">
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-24 lg:w-full">زیر عنوان</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-24 lg:w-full">تعداد QRcode</span>
                        </div>
                        <div
                            class="px-1 py-3 w-[404px] lg:w-[530px] text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-3">
                            <span class="block w-[404px] lg:w-[530px]">عملیات</span>
                        </div>
                    </div>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="w-10 lg:w-full">
                                            <input type="checkbox" class="check" name="menus[]"
                                                value="{{ $menu->id }}">
                                        </div>
                                    </div>
                                    <div
