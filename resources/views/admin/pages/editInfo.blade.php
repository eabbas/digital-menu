<div class="relative p-2 border-2 border-zinc-400 border-dashed rounded-lg">
    <div class="relative">
        <button onclick="pup_up_edit('oppen')" class=" absolute -top-15 w-8 h-8 bg-zinc-200 rounded-lg cursor-pointer flex items-center justify-center">
        ...
        <div id="pup_up_edit_profile" class="fixed top-0 left-0 lg:w-[calc(100%-265px)] w-full h-full bg-black/30 z-50 flex items-center justify-center opacity-0 invisible transition-all duration-500">
            <div class="w-96 bg-white rounded-xl z-50 p-5 shadow-2xl">
                ...
                <div class="flex justify-center">
                    <button onclick="saveAllChanges()" class="w-24 bg-gray-800 rounded-md text-white flex items-center justify-center p-1.5 text-sm hover:bg-gray-900 transition-all duration-300">
                        ثبت
                    </button>
                </div>
            </div>
