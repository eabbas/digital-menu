...
@section('content')
    <div class="flex items-start justify-center">
        <div class="bg-white rounded-2xl p-3 w-full lg:w-3/4">
            ...
            <form action="{{ route('introCat.update') }}" method="post" class="text-center mb-4" enctype="multipart/form-data">
                @csrf
                <div class="w-full flex flex-col gap-3 my-4">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <input
                                    ...
                                    placeholder="عنوان دسته" required value="{{ $category->title }}">
                        </div>
                    </div>
                    <div
                            class="w-full flex flex-col gap-3 itmes-center max-md:flex-col max-md:gap-1">
                    ...
                    <div
                        ...
                        <input type="checkbox" name='show_in_home' id="show_in_home" value="1" @if($category->show_in_home == 1 ) checked @endif>
                    </div>
                </div>
