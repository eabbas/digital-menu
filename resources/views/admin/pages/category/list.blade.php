...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            <a href="{{ route('introPro.create' , [$page->id]) }}">ایجاد محصول</a>
            ...
            <form class="flex flex-col gap-5" action="{{ route('introCat.deleteAll') }}" method="post">
                ...
                <div class="w-11/12 mx-auto flex flex-row justify-between items-center">
                    ...
                    <div class="flex justify-center items-center gap-5">
                        <a href="{{ route('introCat.create', [$page->id]) }}" class="text-sm text-blue-600 font-bold">ایجاد دسته</a>
                        <button
                                ...
                                @if ($category)
                                    <div
                                        ...
                                        <div
                                            ...
                                            <span
                                               class="block w-20 lg:w-full">{{ $category->title }}</span>
                                        </div>
                                        <div
                                                class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                            <span
                                        ...
                                        <div class="col-span-2">
                                            <ul class="w-[120px] lg:w-full text-sm mt-1 rounded-sm p-1 grid grid-cols-2">
                                                <li class="flex justify-center">
                                                    <a href="{{ route('introCat.edit', [$category->id]) }}"
                                                ...
                                                <li class="flex justify-center">
                                                    <a href="{{ route('introCat.delete', [$category->id]) }}"
