...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست درس های رشته {{$field->title}}</h2>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-nowrap text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">مدت زمان</span>
                        </div>
                        ...
                        @if ($field->lessons)
                            ...
                            {{-- @dd($lesson->fields); --}}
                                ...
                                <div class="w-10 lg:w-full">
                                    <input type="checkbox" class="check" name="fields[]" value="{{ $lesson->id }}">
                                </div>
                               </div>
                                 <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                        ...
                                        <div
                                            ...
                                            <a href="{{ route('lesson.single', [$lesson->id]) }}"
                                                class="block w-20 lg:w-full">{{ $lesson->title }}</a>
                                        </div>
                                        <div
                                            class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                            <a href="{{ route('institute.single', [$lesson->field->institute->id]) }}"
                                                class="block w-20 lg:w-full">{{ $lesson->field->institute->title }}</a>
                                        </div>
                                        <div
                                        class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 w-[500px]  lg:w-full text-center col-span-2">
                                         <span class="block w-20 lg:w-full">{{$lesson->duration}} ساعت آموزش</span>
                                    </div>
