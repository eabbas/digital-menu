    ...
    @section('content')
        ...
        <form action="{{ route('field.store') }}" method="post" enctype='multipart/form-data'>
            ...
            <div class="min-h-screen flex items-start justify-center font">
                        ...
                        <div class="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 my-4">
                            <div class="w-full flex flex-col gap-3 itmes-center max-md:flex-col max-md:gap-1">
                                <label class="w-30 text-sm mb-1 mt-2.5 flex">
                                     <span class="required-star text-red-400">*</span>نام رشته
                                </label>
                                <div
                                    class="rounded-lg focus:border-none focus:outline-none focus:bg-[#F1F1F4] bg-[#F9F9F9] text-[#99A1B7] w-full flex">
                                    <input class="p-4 w-full focus:outline-none text-sm font-bold mr-2" type="text"
                                        name='title' placeholder="نام رشته را وارد کنید"required>
                                </div>
                            </div>
                            ...
                            <div class="w-full flex flex-col gap-3 itmes-center max-md:flex-col max-md:gap-1 lg:col-span-2">
                                ...
                                <div
                                    ...
                                    <textarea class="p-4 w-full focus:outline-none text-sm font-bold mr-2" type="text"
                                        name='description' placeholder="توضیحات رشته را بنویسید"></textarea>
                                </div>
                            </div>
                        </div>
