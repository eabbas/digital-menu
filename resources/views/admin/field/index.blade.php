...
@section('content')
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست رشته ها</h2>
                            ...
                            <div class="w-full flex flex-row lg:grid lg:grid-cols-12 items-center divide-x divide-[#f1f1f4]">
                                ...
                                <div class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center">
                                    <div class="w-10 lg:w-full">
                                        <input type="checkbox" class="check" name="fields[]" value="{{ $field->id }}">
                                    </div>
                                </div>
                                ...
                                <div class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 text-center col-span-2">
                                    <a href="{{ route('institute.single', [$field->institute->id]) }}"
                                       class="block w-20 lg:w-full">{{ $field->institute->title }}</a>
                                </div>
                                <div class="p-1 lg:p-3 text-xs lg:text-sm h-full flex items-center justify-center text-gray-900 w-[500px] lg:w-full text-center col-span-2">
                                    ...
                                    <div class="flex flex-row gap-3">
                                        <div class="w-5 h-3 bg-green-500 rounded-full mt-1"></div>
                                    ...
                                    <div class="flex flex-row gap-1">
                                        <div class="w-4 h-3 bg-red-500 rounded-full mt-1"></div>
                                        <span class="block w-20 lg:w-full">
                                            غیرفعال    
                                        </span>
                                    </div> 
                                ...
                                <div class="flex justify-center items-center col-span-3">
                                    <ul class="text-sm mt-1 rounded-sm p-1 grid grid-cols-3 gap-8">
                                         <li class="flex justify-center">
                                            <a href="{{ route('field.single', [$field]) }}"
                                ...
                                <li class="flex justify-center">
                                    <a href="{{ route('field.delete', [$field]) }}"
