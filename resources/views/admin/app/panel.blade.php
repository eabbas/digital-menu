                    ...
                    <ul
                        ...
                        @if (count(Auth::user()->ecomms))
                            <li
                                ...
                                <span class="size-1 bg-white rounded-sm"></span>
                                <a href="{{ route('ecomm_category.index') }}" class="text-white py-1 block"> دسته ها
                                </a>
                            </li>
                        @endif
                        ...
                        <li
                            ...
                            <span class="size-1 bg-white rounded-sm"></span>
                            <a href="{{ route('ecomm_category.create') }}" class="text-white py-1 block">ایجاد دسته
                            </a>
                        </li>
                        @if (count(Auth::user()->ecomms))
                            <li
                    ...
                    <div class="dashboard">
                        ...
                        <ul
                            ...
                            <li
                                ...
                                <span class="size-1 bg-white rounded-sm"></span>
                                <a href="{{ route('checkList.myList') }}" class="text-white py-1 block">لیست چک لیست
                                    های
                                    من</a>
                            </li>
                            ...
                            @if (Auth::user()->role[0]->title == 'admin')
                                <div class="pt-3">
                                    ...
                                    <ul
                                        ...
                                        @if (in_array(1, $ids) || in_array(4, $ids))
                                            <li
                                                class="pr-3.5 @if (Route::is('user.myUsers')) bg-gray-100 @endif">
