...
@section('content')
    ...
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            <div class="pb-4">
                <h2 class="text-lg font-bold text-gray-800 p-2.5">لیست دسته بندی کسب و کار</h2>
            </div>
            <div class="flex flex-col gap-5">
                <div class="overflow-x-auto shadow-md w-3/4 mx-auto mb-5" style="scrollbar-width: none;">
                    <div class="min-w-full bg-gray-200">
                        <div class="bg-gray-100 grid grid-cols-6 items-center divide-x divide-[#f1f1f4]">
                            <div class="px-6 py-3 text-center text-xs font-medium text-gray-600">ردیف</div>
                            <div class="px-6 py-3 text-center text-xs font-medium text-gray-600"> عکس دسته</div>
                            <div class="px-6 py-3 text-center text-xs font-medium text-gray-600">نام دسته</div>
                            <div class="px-6 py-3 text-center text-xs font-medium text-gray-600">نمایش در صفحه</div>
                            <div class="px-6 py-3 text-center text-xs font-medium text-gray-600 col-span-2">عملیات</div>
                        </div>
                            ...
                            @foreach ($careerCategories as $careerCategory)
                                <div class="grid grid-cols-6 items-center divide-x divide-[#f1f1f4]">
                                    ...
                                    <div class="w-full grid grid-cols-3 col-span-2 h-full divide-x divide-[#f1f1f4]">
                                        ...
                                        <div class="flex justify-center items-center">
                                            <div>
                                                <a href="{{ route('cc.edit', [$careerCategory]) }}"
                                        ...
                                        <div class="flex justify-center items-center">
                                            <div>
                                                <a href="{{ route('cc.delete', [$careerCategory]) }}" class="w-fit flex flex-row items-center justify-center bg-red-500 hover:bg-red-600 p-1 rounded-sm" title="حذف">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4"
                                                        viewBox="0 0 448 512">
                                                        <path fill="white"
