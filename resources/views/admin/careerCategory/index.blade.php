...
@section('content')
    ...
    <div class="w-full flex flex-col pb-4">
        <div class="bg-white rounded-lg">
            ...
            <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست دسته های کسب و کار</h2>
                ...
                <div class="w-10/12 mx-auto shadow-md rounded mb-5 overflow-x-auto [&::-webkit-scrollbar]:hidden">
                    <div
                        ...
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">نام دسته</span>
                        </div>
                        <div class="px-1 lg:px-6 py-3 text-center text-xs font-medium text-gray-600 bg-gray-100 col-span-2">
                            <span class="block w-20 lg:w-full">نمایش در خانه</span>
                        </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    @if ($careerCategory->show_in_home == 1)
                                        <span class="block w-20 lg:w-full">✅</span>
                                    @else
                                        <span class="block w-20 lg:w-full">❌</span>
                                    @endif
                                </div>
                                ...
                                <div class="col-span-3">
                                    <ul class="w-[270px] text-sm mt-1 rounded-sm p-1 grid grid-cols-3">
                                        ...
                                        <li class="flex justify-center">
                                            <a href="{{ route('cc.delete', [$careerCategory]) }}"
