@extends('admin.app.panel') @section('title', 'صفحه تک دسته')
@section('content')
<div class="w-full">
    <div class="pb-5 w-full">نام دسته
        <h1 class="text-xl text-center lg:text-start">{{ $ecomm_category->title }}</h1>
        <div
    ...
    <div class="flex flex-col border-none rounded-[7px]">عکس دسته
    ...
    <div class="pt-3 mt-4 lg:mt-8">
        ...
        <div class="flex flex-row justify-between items-center">
            ...
            <div class="p-1 lg:p-3 text-xs text-center lg:text-sm h-full flex items-center justify-center font-medium">
                <!-- <a href="{{ route('client.ecomm_categoryMenu', [$ecomm_category])}}" class="text-sky-700">مشاهده منو</a> -->
            </div>
            @endif  
        </div>
