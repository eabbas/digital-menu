...
@section('title')
    دسته های {{ $ecomm->title }}
@endsection
@section('content')
<div class="w-full flex flex-col pb-4">
    <div class="bg-white rounded-lg">

        <h2 class="text-lg font-bold text-gray-800 p-4 text-center">لیست دسته های {{ $ecomm->title }}</h2>
        ...
        <form class="flex flex-col gap-5" action="{{ route('ecomm_category.deleteAll') }}" method="post">
            ...
            <div class="flex justify-end w-11/12 mx-auto">
                <a href="{{ route('ecomm_category.create') }}"
                   class="px-5 py-1 rounded-sm bg-blue-500 hover:bg-blue-600 text-white text-xs lg:text-base">ایجاد دسته </a>
            </div>
