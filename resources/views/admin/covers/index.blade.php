                            ...
                            @foreach ($covers as $cover)
                                @if ($cover)
                                    <div class="w-full flex flex-row justify-between shadow-sm items-center px-3">
                                        ...
                                        <div class="lg:w-3/12 flex flex-row justify-end items-center gap-3">
                                            ...
                                            <div>
                                                <a href="{{ route('covers.single', [$cover]) }}" class="inline-block p-1 lg:p-2 rounded-md bg-gray-100 cursor-pointer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 512 512">
