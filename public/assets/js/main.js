    ...
    <div class="flex flex-col items-start lg:items-end gap-3 lg:gap-5 mt-3 md:mt-5 border-b border-gray-300 pb-3">
        <div class="w-full flex flex-row justify-between gap-2">
            <div class="flex flex-col">
                ...
                <input type="text" class="outline-none w-full pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]"
                    placeholder="نام" name="menu_data[${featureCount}][name]">
            </div>
            <div class="flex flex-col">
                <label class="font-bold mb-2"> تصویر :</label>
                <input type="file" class="outline-none w-full lg:w-1/2 pr-5 py-3 cursor-pointer"
                    name="menu_data[${featureCount}][menu_image]">
            </div>
            <div>
                <button type="button" class="p-2 rounded-md bg-rose-500 hover:bg-rose-600 text-white cursor-pointer"
            ...
            <div class="w-full flex flex-row items-end gap-3">
                <div class="flex flex-col lg:flex-row items-center pr-10 gap-3">
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <input type="hidden" name="menu_data[${featureCount}][values][${valueCount}][id]"
                        value="${valueId}">
                    </div>
                </div>
        ...
        <div class="w-full flex flex-row items-end gap-3">
            <div class="flex flex-col lg:flex-row items-center pr-10 gap-3 mt-8 mb-0">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="number" placeholder="500.000تومان"
                        class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]"
                        name="menu_data[${num}][values][${valueCount}][price]">
                </div>
                <div class="w-full flex flex-col">
                    <label class="text-[#425a8bde] mb-2"> توضیحات آیتم :</label>
                    <input type="text" class="outline-none pr-5 py-3 bg-[#F9F9F9] rounded-xl focus:bg-[#f1f1f4]"
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="hidden" name="menu_data[${featureCount}][values][${valueCount}][id]" value="${valueId}">
                </div>
            </div>
            <div class="flex items-end">
                <button type="button"
